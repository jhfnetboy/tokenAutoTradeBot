...
const mnemonic = process.env.PRIVATE_KEY //your memonic;
// const tokenIn = data.WBNB;
const tokenIn = data.to_SELL;
...
const run = async () => {
  ...
  let buyAction = async() => {
    ...
    try{
      ...
      const amountIn = ethers.utils.parseUnits(`${data.AMOUNT_OF_SELL}`, 'ether');
...
app.listen(PORT, console.log(chalk.yellow(`Listening for Liquidity Addition to token ${data.to_SELL}`)));
